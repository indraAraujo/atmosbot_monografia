...
%%%%%
\input{CAPA-ElementosPreTextuais}
...
\input{TEXTO-RevisaoBibliografica}

\chapter{Trabalhos Correlatos}
\label{cap-trabalhos-relacionados}
\input{TEXTO-TrabalhosCorrelatos}
...
\input{TEXTO-ResultadosDiscussao}

\chapter{Considerações Finais}
\label{cap-consideracoesFinais}
\input{TEXTO-ConsideracoesFinais}
